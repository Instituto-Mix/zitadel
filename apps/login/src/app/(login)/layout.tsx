              ...
              <LanguageProvider>
                ...
                >
                  <div className="relative mx-auto w-full max-w-[1100px] py-8">
                    <div>{children}</div>
                    {/* Keep the language/theme controls aligned with the 440px card on all breakpoints */}
                    <div className="mx-auto flex max-w-[440px] flex-row items-center justify-end space-x-4 px-4 py-4">
